...
interface Props {
  ...
  tooltip?: (materialStandard: MaterialStandard) => string
}

const props = defineProps<Props>()

const computedTooltip = computed(() => {
  return props.tooltip ? props.tooltip(props.materialStandard) : undefined
})
</script>

<template>
  <n-tooltip :disabled="!computedTooltip" trigger="hover">
    <template #trigger>
      <div
